const CACHE='scalabrini-client-v12-9';
const PRECACHE=[
  './','./index.html','./styles.css?v=12.4','./app.js?v=12.7.1','./push.js?v=12.4','./membership.css?v=11.2','./membership.js?v=11.2','./site.webmanifest','./equipe/','./equipe/index.html','./equipe/team.css?v=12.3.1','./equipe/settings.css?v=12','./equipe/team.js?v=12.7','./equipe/agenda-cancelados-v12.8.js?v=12.8','./equipe/finance-reports.js?v=12.8.1','./equipe/settings.js?v=12.7.1','./equipe/barberium-v12.9.js?v=12.9',
