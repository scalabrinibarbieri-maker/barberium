const CACHE='scalabrini-client-v7';
const PRECACHE=[
  './','./index.html','./styles.css?v=7','./app.js?v=7','./site.webmanifest','./equipe/','./equipe/index.html','./equipe/team.css?v=1','./equipe/team.js?v=1',
...
self.addEventListener('fetch',event=>{
  ...
  if(event.request.mode==='navigate'){
    event.respondWith(networkFirst(event.request).catch(()=>new URL(event.request.url).pathname.includes('/equipe')?caches.match('./equipe/index.html'):caches.match('./index.html')));
    return;
  }
