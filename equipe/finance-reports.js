...
function summaryRows(data){const o=data.overview||{};return [
  ['Receita bruta',money(o.gross_cents)],['Taxas',money(o.fees_cents)],['Receita líquida',money(o.net_received_cents)],['Comissões',money(o.commissions_cents)],['Despesas pagas',money(o.expenses_cents)],['Resultado operacional',money(o.operating_result_cents)],['Contas a receber',money(o.receivables_cents)]
]}
